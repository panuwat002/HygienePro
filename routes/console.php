...
// ปิดภารกิจสุ่มตรวจที่เลยวันแล้วไม่มีใครทำ → 'missed'
// 07:00 เพราะรอบตรวจที่เริ่มก่อน 06:00 ยังนับเป็นงานของเมื่อวาน — ปิดเร็วกว่านี้
// จะตัดรอบดึกทิ้งทั้งที่เขายังทำอยู่
Schedule::command('audit:close-missed')->dailyAt('07:00');

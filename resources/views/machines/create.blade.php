<x-app-layout>
    @section('header', 'เพิ่มเครื่องจักรใหม่ (New Machine)')
                    ...
                    <form action="{{ route('machines.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" placeholder="Ex. MC-001">
                            </div>
                        </div>
